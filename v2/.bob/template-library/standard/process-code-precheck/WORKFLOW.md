...
requires:
  workspace: true
  bob: { minVersion: "2.0.0" }
  files:
    - .bob/process/process-catalog.yaml
    - .bob/process/checklists/code-precheck.yaml
inputs:
  ...
  checklistPath: { type: string, title: checklist, default: .bob/process/checklists/code-precheck.yaml }
