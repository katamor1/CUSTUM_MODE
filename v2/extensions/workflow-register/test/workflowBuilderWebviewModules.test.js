...
test("workflow builder split modules expose approval, markdown body, help, and guided navigation pieces", () => {
  ...
  assert.match(script, /data-guardrail-field="allowedCommandIds"/)
  assert.match(script, /data-guardrail-field="deniedCommandIds"/)
...
test("workflow builder help id registry exposes known ids", () => {
  ...
  assert.equal(isWorkflowBuilderHelpId("guardrails.allowedCommandIds"), true)
  assert.equal(isWorkflowBuilderHelpId("guardrails.deniedCommandIds"), true)
...
test("workflow builder help catalog covers high priority Japanese help entries", () => {
  ...
  assert.match(workflowBuilderHelpCatalog["guardrails.allowedCommandIds"].summary, /VS Code command ID/)
  assert.match(workflowBuilderHelpCatalog["guardrails.deniedCommandIds"].summary, /VS Code command ID/)
